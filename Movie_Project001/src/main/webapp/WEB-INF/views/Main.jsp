...
<html lang="en">
    ...
    <body>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="C:\Users\hesuh\stool_workspace\Movie_Project001\src\main\webapp\resources\memberProfile\영화이미지.jpg" alt="..." /></div>
                    <div class="col-md-6">
        ...
        <button onclick="sssss()">바텀 표시</button>
        
        <!-- Related items section-->
        <div id="b22" class="d_none">
    ...
    function sssss(){
    	console.log("b22호출");
    	 var infoObj = document.getElementById('b22');
